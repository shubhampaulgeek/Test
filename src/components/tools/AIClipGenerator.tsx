        ...
        {result && (
         ...
         <Card>
           <CardHeader>
             ...
             <CardDescription>Maximize the quality of your generated content</CardDescription>
           </CardHeader>
           <CardContent>
             <ul className="space-y-2 text-sm text-gray-600">
               <li>• <strong>Transcript:</strong> Focus on the most exciting 30-60 seconds of your stream</li>
               <li>• <strong>Chat Log:</strong> Include reactions like "OMGGGG", "CLIP IT", "NO WAY" for context</li>
               <li>• <strong>Style:</strong> Choose Gaming for epic moments, Funny for humor, Educational for learning</li>
