          ...
          {videoInfo.learningInsights && (
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-200">
              ...
              {videoInfo.learningInsights.topLanguages.length > 0 && (
                <div className="mb-6">
                  <h4 className="font-semibold mb-3">🔤 Languages Detected Till Date:</h4>
                  <div className="flex flex-wrap gap-2">
              ...
              {videoInfo.learningInsights.topEmojis.length > 0 && (
                <div>
                  <h4 className="font-semibold mb-3">😊 Most Common Emojis Detected Till Date:</h4>
                  <div className="flex flex-wrap gap-2">
